        ...
        {pursuits.map((p, i) => (
          <li key={p.label}>
            <motion.button
              ...
              whileHover={{ y: 2, scale: 0.96 }}
              whileTap={{ y: 3, scale: 0.94 }}
              transition={{ type: "spring", stiffness: 500, damping: 26 }}
              className="group relative flex aspect-square w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-sm border border-paper/12 bg-ink-900 shadow-[0_3px_0_rgba(0,0,0,0.35)] transition-shadow duration-300 hover:shadow-none"
            ...
            >
              ...
              <span
                aria-hidden
                className="pointer-events-none absolute inset-[5px] rounded-[1px] border border-paper/10 transition-colors duration-300 group-hover:border-ink-950/30"
              />
              <p.icon className="relative h-6 w-6 text-paper-dim transition-colors duration-300 group-hover:text-ink-950 sm:h-7 sm:w-7" />
              <span className="relative text-[10px] font-mono tracking-wide text-paper-faint transition-colors duration-300 group-hover:text-ink-950">
                {p.label}
              </span>
            </motion.button>
          </li>
