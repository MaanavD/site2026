      ...
      <div className="mx-auto grid max-w-6xl gap-16 px-6 py-28 md:grid-cols-[1fr_1.2fr] md:items-center">
        <Reveal className="mx-auto w-full max-w-sm">
          <div className="relative">
            <span className="absolute -inset-3 rounded-sm border border-madder/40" />
            <div className="relative overflow-hidden rounded-sm">
              <Image
                ...
                width={750}
                height={500}
                sizes="(max-width: 431px) calc(100vw - 3rem), (max-width: 767px) 24rem, (max-width: 956px) calc(45.455vw - 3.182rem), 24rem"
            ...
            <span className="absolute -bottom-4 -right-4">
              <Gloss gloss="hand stamped, like everything here" side="top">
